...
} from '@cognigy/rest-api-client/build/shared/mongoose/pagination';

const MAX_LIMIT = 100;
type TIndexFn<Query extends IRestPagination<Entity>, Entity> = (
  query: Query
) => Promise<ICursorBasedPaginationReturnValue<Entity>>;
