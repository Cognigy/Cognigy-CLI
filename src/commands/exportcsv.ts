 ...
 */
export const exportcsv = async ({ resourceType, resourceName }): Promise<void> => {
    ...
    console.log(`Starting to export CSV from ${upperFirst(resourceType)} ${resourceName} ... \n`);
    ...
    switch (resourceType) {
        ...
        default:
            console.log(`Resource type ${resourceType} can't be used for CSV export.`);
    }
